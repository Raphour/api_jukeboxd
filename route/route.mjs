...
import contentInformationController from "../controller/contentInformationController.mjs";
...
router
    ...
    .get(async (req, res) => {
        ...
        res.send(await contentInformationController.findAll())
    })
    .post(async (req, res) => {
...
router.route('/content/:deezerId/ratings')
    .get(async (req, res) => {
        // #swagger.summary = 'Recupere les notes d'un contenu par son deezerId'
        // #swagger.description = ''
        res.send(await contentInformationController.findRatings(req.params["deezerId"]))
    })
    .post(async (req, res) => {
        // #swagger.summary = 'Ajoute une note à un contenu'
        // #swagger.description = ''
        res.send(await contentInformationController.addRating(req.params["deezerId"], req.body["username"]))
...
router.route('/content/:deezerId/listened')
    ...
    .get(async (req, res) => {
        res.send(await contentInformationController.findByDeezerId(req.params["deezerId"]["listened"]))
    })

router.route('/content/:deezerId/favorite')
    .get(async (req, res) => {
        // #swagger.summary = 'Recupere les utilisateurs ayant mis en favoris un contenu'
        res.send(await contentInformationController.findByDeezerId(req.params["deezerId"]["favorites"]))
    })
...
router.route('/content/:deezerId/listened/:username')
    .post(async (req, res) => {
        ...
        res.send(await contentInformationController.addListenedContent(req.params["deezerId"], req.params["username"]))
    })
    .delete(async (req, res) => {
        // #swagger.summary = 'Retire un utilisateur de la liste des utilisateurs ayant écouté un contenu'
        res.send(await contentInformationController.removeListenedContent(req.params["deezerId"], req.params["username"]))
    })

router.route('/content/:deezerId/favorite/:username')
    .post(async (req, res) => {
        res.send(await contentInformationController.addFavoriteContent(req.params["deezerId"], req.params["username"]))
    })
    .delete(async (req, res) => {
        res.send(await contentInformationController.removeFavoriteContent(req.params["deezerId"], req.params["username"]))
    })
